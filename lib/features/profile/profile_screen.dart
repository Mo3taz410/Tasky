...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void _loadData() async {
    ...
    motivationQuote =
        SharedPreferencesManager().getString(StorageKeys.motivationQuote) ?? 'One task at a time.One step closer.';
    profilePicturePath = SharedPreferencesManager().getString(StorageKeys.profilePicture);
    isLoading = false;
    setState(() {});
  }
    ...
    return isLoading
        ...
        : SingleChildScrollView(
            child: Column(
              ...
              children: [
                Text('My Profile', style: Theme.of(context).textTheme.labelLarge),
                ...
                ListTile(
                  onTap: () async {
                    final bool? result = await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => UserDetailsScreen(name: name, motivationQuote: motivationQuote),
                      ),
                    );
                ...
                ListTile(
                  onTap: () async {
                    ...
                    SharedPreferencesManager().remove(StorageKeys.motivationQuote);
  ...
  void _saveProfilePicture(XFile file) async {
    ...
    SharedPreferencesManager().setString(StorageKeys.profilePicture, newFile.path);
  }
}
